...
class TimesViewController: UITableViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    let fullday = [
        ...
        ("3rd Hour", "9:29 - 10:32 (63 minutes with announcements)"),
        ...
        ("Notice", "There will be a tone at 8:16, 9:20, 10:29, 12:05 and 1:09 to release travelers to their next class. All non-traveling students must remain in class until the official end of the period.")
    ]
    ...
    let halfday = [
        ...
        ("Notice", "There will be a tone at 7:45, 8:19, 8:58, 9:32 and 10:06 to release travelers to their next class. All non-traveling students must remain in class until the official end of the period.")
    ]
    ...
    let latestart = [
        ...
        ("Notice", "There will be a tone at 10:08, 10:45, 11:22, 12:58 and 1:35 to release travelers to their next class. All non-traveling students must remain in class until the official end of the period.")
    ]
